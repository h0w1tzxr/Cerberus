...
func renderTaskAddHelp(out io.Writer) {
	...
	fmt.Fprintln(out, "")
	fmt.Fprintln(out, "Usage:")
	fmt.Fprintln(out, "  cerberus task add --hash <hash> --mode md5|sha256 [--wordlist path] [--keyspace N] [--chunk N] [--priority N] [--max-retries N]")
	fmt.Fprintln(out, "")
...
func renderTaskAddBatchHelp(out io.Writer) {
	...
	fmt.Fprintln(out, "")
	fmt.Fprintln(out, "Usage:")
	fmt.Fprintln(out, "  cerberus task add-batch --file hashes.txt --mode md5|sha256 [--wordlist path] [--keyspace N] [--chunk N] [--priority N] [--max-retries N]")
	fmt.Fprintln(out, "  cerberus task add-batch --stdin --mode md5|sha256 [--wordlist path] [--keyspace N] [--chunk N] [--priority N] [--max-retries N]")
	fmt.Fprintln(out, "")
	fmt.Fprintln(out, "Flags:")
